...
def generate_script():
    ...
    # HuggingFace kan returnera olika format
...
def generate_image(prompt_text):
    ...
    if "image_base64" not in data:
        raise ValueError("Bildgenerering misslyckades: ingen image_base64 i svaret.")
...
def build_video(image_path, script_text):
    # Spara manus som text-overlay (kan användas senare)
